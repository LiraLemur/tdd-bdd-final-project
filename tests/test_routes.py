...
class TestProductRoutes(TestCase):
    ...
    def test_get_product_not_found(self):
        """If product was not found correct error"""
    ...
    def test_list_by_availability(self):
        """Listing by availability"""
        products = self._create_products(5)
        availables = [product for product in products if product.available is True]
        available_count = len(availables)
